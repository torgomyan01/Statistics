...
function Page() {
  ...
  return (
    <MainTemplate>
      <div className="w-full h-full bg-gray-100 dark:bg-gray-900 transition-colors duration-500 font-inter">
        <main className="w-full px-4 sm:px-6 lg:px-8 py-12">
          <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-2xl mb-12 border-t-4 border-indigo-600 dark:border-indigo-500 transition-colors duration-500">
            ...
            <div className="flex flex-col md:flex-row gap-8 justify-around">
              ...
              <Select className="max-w-xs" label="Select Year">
                {Array.from({ length: 65 }).map((_, index) => (
                  <SelectItem key={`year-${1960 + index}`}>
                    {1960 + index}
                  </SelectItem>
                ))}
              </Select>
